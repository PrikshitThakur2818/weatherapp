...
const WeateherApp = () => {
  ...
  let api_key = "8874d7b9621cb4e5a79373717553d3ef";
  ...
  const search = async()=>{
     ...
     const temperatue = document.getElementsByClassName('weather-temp');
     const location = document.getElementsByClassName('weather-location');

     humidity[0].innerHTML = data.main.humidity + "%";
     wind[0].innerHTML = data.wind.speed + " Km/h";
     temperatue[0].innerHTML = data.main.temp + "°c";
